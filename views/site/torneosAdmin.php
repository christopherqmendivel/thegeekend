...
<body>
    <div class="container-torneos">
        <div class="row row-one-torneos">
            <div class="col-5">
                <h1><?= Html::encode($this->title) ?></h1>
                <canvas id="torneosPorModalidadChart"></canvas>
            </div>

            <div class="col-5 col-circle">
